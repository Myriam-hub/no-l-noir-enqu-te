...
export const Header = () => {
  ...
  const navItems = [
    ...
    { path: '/leaderboard', label: 'Classement', icon: FileText },
    { path: '/admin', label: 'Dossiers', icon: Fingerprint },
  ];
        ...
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="font-typewriter text-lg text-accent tracking-wider">
                DOSSIER N°2024
              </span>
